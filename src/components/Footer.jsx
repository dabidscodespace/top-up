        ...
        <div className="relative">
          ...
          <div className="text-center pt-8 space-y-2">
            <p className="text-gray-400 font-bold text-sm">
              ...
              <span className="font-black text-teal ml-1">TOPUP X</span>.
              All rights reserved.
            </p>
            <p className="text-gray-500 text-xs">Design and Developed with love by <span className="font-black text-teal ml-1">Dabid Marma</span></p>
          </div>
        </div>
      </div>
    </footer>
